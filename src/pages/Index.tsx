    ...
    <TooltipProvider delayDuration={150}>
      <div className="min-h-screen bg-slate-50 text-slate-900 overflow-hidden relative font-body">
        ...
        <nav className="relative z-10 max-w-6xl mx-auto px-6 pt-8 flex items-center gap-3">
          ...
          <span className="text-sm text-slate-700 font-medium">Этапы процедуры</span>
        </nav>

        {/* Hero */}
        <header className="relative z-10 max-w-6xl mx-auto px-6 pt-12 pb-10 text-center">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pb-16">
          <div
            className="rounded-3xl bg-white border border-slate-200 shadow-sm p-8 flex flex-col md:flex-row items-center gap-6 justify-between animate-fade-in"
            style={{ animationDelay: '1.1s', opacity: 0 }}
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-md shrink-0">
                <Icon name="AlertTriangle" size={24} className="text-white" fallback="Alert" />
              </div>
              <div>
                <h3 className="font-heading font-bold text-lg text-slate-900">Последствия банкротства</h3>
            ...
            <button
              ...
              className="shrink-0 inline-flex items-center gap-2 px-6 py-3 rounded-2xl bg-amber-500 text-white font-semibold text-sm hover:bg-amber-600 transition-colors shadow-md"
            >
              Перейти
